...
az aks get-credentials --resource-group nonprod-cluster-eastus2 --name aks-eva9o-nonprod --subscription evans
...
az aks get-credentials --resource-group nonprod-cluster-eastus2 --name aks-usmmg-nonprod --subscription multimodalgroup
...
az aks get-credentials --resource-group prod-cluster-centralus --name aks-dg3nl-prod --subscription dollargeneral
...
az aks get-credentials --resource-group prod-cluster-centralus --name aks-pep5c-prod --subscription pepsi
...
az aks get-credentials --resource-group prod-cluster-centralus --name aks-usmmg-prod --subscription multimodalgroup
